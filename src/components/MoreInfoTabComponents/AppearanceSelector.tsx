...
//           <TouchableOpacity
//             key={appearance}
//             style={[styles.option, selectedAppearance === appearance && styles.selectedOption]}
//             onPress={() => setSelectedAppearance(appearance)}
//           >
//             <Text style={[styles.optionText, selectedAppearance === appearance && styles.selectedOptionText]}>
//               {appearance}
//             </Text>
//           </TouchableOpacity>
//         ))}
