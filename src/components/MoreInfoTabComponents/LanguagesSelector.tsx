...
//       const updatedLanguages = setSelectedLanguages(selectedLanguages.filter(({item}: any) => item !== lang));
//       console.log('After removing:', updatedLanguages);
//     } else {
//       const updatedLanguages = setSelectedLanguages([...selectedLanguages, lang]);
...
//           <TouchableOpacity
//             key={lang}
//             style={[styles.option, selectedLanguages.includes(lang) && styles.selectedOption]}
//             onPress={() => toggleLanguage(lang)}
//           >
//             <Text style={[styles.optionText, selectedLanguages.includes(lang) && styles.selectedOptionText]}>
//               {lang}
//             </Text>
//           </TouchableOpacity>
//         ))}
