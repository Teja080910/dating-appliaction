...
//         {/* <Image
//           source={require('./assets/logo.png')} // ✅ Put your logo.png here
//           style={styles.logo}
//         /> */}
...
//           <TextInput placeholder="Enter your e-mail address" placeholderTextColor="#666" style={styles.input} />
//         </View>

//         <View style={styles.inputWrapper}>
//           <Icon name="lock-outline" size={20} color="#e14c61" style={styles.icon} />
//           <TextInput placeholder="Enter your password" placeholderTextColor="#666" secureTextEntry style={styles.input} />
//         </View>
